...
class Review(BaseModel):
    ...
    sentiment: Annotated[str, Field(description='The overall sentiment of the review, either "Positive", "Negative", or "Neutral"')]
    key_themes: Annotated[List[str], Field(description="A list of key themes mentioned in the review")]
    pros: Annotated[Optional[List[str]], Field(description="A list of positive aspects mentioned in the review")]
    cons: Annotated[Optional[List[str]], Field(description="A list of negative aspects mentioned in the review")]
